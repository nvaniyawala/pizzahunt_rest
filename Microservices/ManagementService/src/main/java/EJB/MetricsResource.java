...
public class MetricsResource {
    ...
    public String getMetrics() {
       ...
       return "application_EJB_ManagementBean_getOutlets_4x{_app=\"managementservice\"} "+ _4xCount+"\napplication_EJB_ManagementBean_getOutlets_5x{_app=\"managementservice\"}"+ _5xCount;
