...
public class MetricsResource {
    ...
    public String getMetrics() {
       ...
       return "application_EJB_PreparationBean_sendOrderToDelivery_4x{_app=\"preparationservice\"} "+ _4xCount+"\napplication_EJB_PreparationBean_sendOrderToDelivery_5x{_app=\"preparationservice\"}"+ _5xCount;
